...
<div class="container d-flex justify-content-center">
  <div>
    ...
    <form class="mt-5 rounded" action="/posts/store" method="post" style="background-color: #f0f0f0;">
      @csrf
      <div class="form-group mx-4" style="width: 550px;">
        <labe style="font-weight: bold; color:black; margin-top:1px;">Title</label>
      ...
      <div class="form-group mx-4"  style="width: 550px;">
        <label style="font-weight: bold; color:black; margin-top:1px;">Description</label>
      ...
      <div class="form-group mx-4">
          <button type = "submit" name = "" class = "btn btn-success btn-md mb-4">Add Post</button>
      </div>
    </form>
  </div>
</div>
