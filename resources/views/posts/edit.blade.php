...
<div class="container d-flex justify-content-center">
  <div>
    ...
    <form action="/posts/update" method="post"  style = "margin-top: 30px; background-color: #f0f0f0;">
        @csrf
        @foreach ($posts as $post)
        <div class="form-group  mx-4" style = "margin-top:25px; width: 550px;">
          <label for="" style="font-weight: bold; color:black;" class="mt-4">Title</label>
        ...
        <div class="form-group mx-4" style = "margin-top:25px; width: 550px;">
          <label style="font-weight: bold; color:black; margin-top:1px;" class="mt-4" for="body">Description</label>
        ...
        <div class="form-group mx-4">
            <button type = "submit" class = "btn btn-success btn-md mb-4">Save Change</button>
        </div>
    </form>
  </div>
</div>
